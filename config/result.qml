...
<qgis version="2.12.1-Lyon" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="result" forceraster="0" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="HTTP Error 404" label="404 Not found"/>
      <category render="true" symbol="1" value="succes" label="succes"/>
      <category render="true" symbol="2" value="other" label="other"/>
    </categories>
    <symbols>
  ...
  <displayfield>LO_X</displayfield>
  <label>0</label>
  <labelattributes>

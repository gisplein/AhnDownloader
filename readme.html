...
A temporary vector layer is created with the results. This allows a new attempt to retrieve the missing tiles. To start a new download session you have to push the reset button.  
